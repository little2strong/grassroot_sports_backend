...
class RolesController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            return redirect()->back()
                ->with('notify', [['error', 'Something went wrong while creating the role. Please try again.']]);

        }

        DB::commit();
        return redirect()->back()->with('notify', [['success', 'Role created successfully!']]);
    ...
    public function update(Request $request, $id)
    {
        ...
        DB::commit();
        // Toastr::success(trans('Role updated successfully'), 'Success', ["positionClass" => "toast-top-center"]);
        return redirect()->route('admin.roles.index')
                ->with('notify', [['success', 'Role updated successfully']]);
        // return redirect()->route('admin.roles.index');
    }
